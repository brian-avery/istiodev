...
The Istio community is organized into a set of [working groups](/docs/community/WORKING-GROUPS).
Any contribution to Istio should be started by first engaging with the
appropriate working group.

## Code of conduct

All members of the Istio community must abide by the [Code of Conduct](https://github.com/istio/community/blob/master/CODE-OF-CONDUCT.md).

## Team values

We promote and encourage a set of [shared values](/docs/community/VALUES) to improve our
...
to the drive, you'll need to be a [member](/docs/community/ROLES#member) of the Istio organization.
...
- Discuss your idea with the appropriate [working groups](/docs/community/WORKING-GROUPS) on the working
