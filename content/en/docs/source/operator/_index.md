...
You can [contribute](https://github.com/istio/istio/blob/master/operator/CONTRIBUTING.md) by picking an
...
creating a [bug or feature request](https://github.com/istio/istio/blob/master/operator/BUGS-AND-FEATURE-REQUESTS.md),
...
architecture and a code overview, see [ARCHITECTURE.md](https://github.com/istio/istio/blob/master/operator/ARCHITECTURE.md).
...
The simplest customization is to select a profile different to `default` e.g. `minimal`. See [manifests/profiles/minimal.yaml](https://github.com/istio/istio/blob/master/manifests/profiles/minimal.yaml):
...
The simplest customization is to turn components on and off. For example, to turn on cni ([samples/cni-on.yaml](https://github.com/istio/istio/blob/master/operator/samples/cni-on.yaml):
...
Istio defined schemas ([samples/pilot-k8s.yaml](https://github.com/istio/istio/blob/master/operator/samples/pilot-k8s.yaml)):
...
[schema](https://github.com/istio/istio/blob/master/operator/pkg/apis/istio/v1alpha1/values_types.proto)). Values.yaml settings
are overridden the same way as the new API, though a customized CR overlaid over default values for the selected
profile. Here's an example of overriding some global level default values ([samples/values-global.yaml](https://github.com/istio/istio/blob/master/operator/samples/values-global.yaml)):
...
Values overrides can also be specified for a particular component
 ([samples/values-pilot.yaml](https://github.com/istio/istio/blob/master/operator/samples/values-pilot.yaml)):
...
override some container level values in the Pilot container  ([samples/pilot-advanced-override.yaml](https://github.com/istio/istio/blob/master/operator/samples/pilot-advanced-override.yaml)):
...
See [ARCHITECTURE.md](https://github.com/istio/istio/blob/master/operator/ARCHITECTURE.md)
