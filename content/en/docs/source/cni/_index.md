...
For most Kubernetes environments the `istio-cni` [helm parameters' defaults](https://github.com/istio/istio/blob/master/manifests/charts/istio-cni/values.yaml) will configure the Istio CNI plugin in a manner compatible with the Kubernetes installation.  Refer to
...
Add the following section into [istio-cni.yaml](https://github.com/istio/istio/blob/master/manifests/charts/istio-cni/templates/daemonset.yaml)
...
- [istio-cni.yaml](https://github.com/istio/istio/blob/master/manifests/charts/istio-cni/templates/daemonset.yaml)
