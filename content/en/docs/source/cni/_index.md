...
For most Kubernetes environments the `istio-cni` [helm parameters' defaults](https://github.com/istio/istio/blob/masterdeployments/kubernetes/install/helm/istio-cni/values.yaml) will configure the Istio CNI plugin in a manner compatible with the Kubernetes installation.  Refer to
...
Add the following section into [istio-cni.yaml](https://github.com/istio/istio/blob/masterdeployments/kubernetes/install/helm/istio-cni/templates/istio-cni.yaml#L109)
...
The Istio CNI testing strategy and execution details are explained [here](https://github.com/istio/istio/blob/master/cni/test/README.md).
...
- [istio-cni.yaml](https://github.com/istio/istio/blob/masterdeployments/kubernetes/install/helm/istio-cni/templates/istio-cni.yaml)
...
- [istio-iptables](https://github.com/istio/istio/blob/master/cni/tools/istio-cni-docker.mk)
